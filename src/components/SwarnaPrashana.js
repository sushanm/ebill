...
function SwarnaPrashana() {
    ...
    useEffect(() => {
        ...
        SetSelectedKid(spFeature.kids.filter(item => item.id === selectedKid.id)[0])
        }
    }, [dataChanged])
    ...
    const searchKids = (value) => {
        ...
        if (value) {
            ...
            SetExistingKids(cloneKids.filter(item => search.test(item.name.toLowerCase())))
        }
        else {
        ...
        <>
            <div className="row">
                <div className="col-4 border-r">
                    <div className="row">
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control value={searchChild} onChange={e => searchKids(e.target.value)} type="text" placeholder="Search By Child" />
                        </Form.Group>
                    </div>
                        ...
                        existingKids.map((b, i) => {
                            return (
                                <>
                                    {
                                        selectedKid &&
                                        <div className="row border-b kids-row" onClick={() => selectKid(b)} key={i} style={{ backgroundColor: b.id === selectedKid.id ? '#def1d5' : 'white' }}>
                                            <div className="col-1">{i + 1}</div>
                                            <div className="col-11">{b.name} - {b.age} Years - {b.weight} Kg</div>
                                        </div>
                                    }
                                    {
                                        !selectedKid &&
                                        <div className="row border-b kids-row" onClick={() => selectKid(b)} key={i} >
                                            <div className="col-1">{i + 1}</div>
                                            <div className="col-11">{b.name} - {b.age} Years - {b.weight} Kg</div>
                                        </div>
                                    }
                ...
                <div className="col-8">
                    <div className="row">
                        <div className="col-3">
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                ...
                                <Form.Control value={newKidName} onChange={e => { SetNewKidName(e.target.value) }} type="text" placeholder="Enter Child Name" />
                            </Form.Group>
                        </div>
                        <div className="col-2">
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Child Age</Form.Label>
                                <Form.Control value={newKidAge} type="number" onChange={e => SetNewKidAge(e.target.value)} placeholder="Enter Child Age" />
                            </Form.Group>
                        </div>
                        <div className="col-2">
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Child Weight</Form.Label>
                                <Form.Control value={newKidWeight} type="number" onChange={e => SetNewKidWeight(e.target.value)} placeholder="Enter Child Weight" />
                            </Form.Group>
                        </div>
                        <div className="col-2">
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                {
                                    addnewKid &&
                                    <Button disabled={disableNewKid} variant="primary" className='btn-submit btn-new' type="submit" onClick={addNewKid}>
                                        Add New
                                    </Button>
                                }
                                {
                                    !addnewKid &&
                                    <Button disabled={disableNewKid} variant="warning" className='btn-submit' type="submit" onClick={updateKid}>
                                        Update
                                    </Button>
                                }
                        ...
                        <div className="col-1">
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Button variant="secondary" className='btn-submit' type="submit" onClick={clear}>
                                    Clear
                                </Button>
                            </Form.Group>
                        </div>
                    ...
                    <div className="row">
                        <div className="col">
                            <h5>
                            {
                                selectedKid && 
                                <>
                                Name : <strong>{selectedKid.name}</strong> - <strong>{selectedKid.age}</strong> Years - <strong>{selectedKid.weight} Kg</strong>
                                </>
                            }
                            </h5>
                        </div>
                    ...
                    <div className="row">
                        {
                            selectedKid && selectedKid.spDates &&
